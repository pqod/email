...
class Email(AppBase):
    ...
    def send_email_smtp(
        self, username, password, smtp_host, recipient, subject, body, smtp_port, from_username, attachments="", ssl_verify="True", body_type="html"
    ):
        ...
        msg = MIMEMultipart()
        msg["From"] = from_username if from_username else username
        msg["To"] = recipient
        msg["Subject"] = subject
